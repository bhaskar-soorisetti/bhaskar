...
public class Apptest2{
	public static void main(String[] args) throws Exception 
	{
		...
		Thread.sleep(10000);
		dr.findElement(By.xpath("//*[@content-desc='plus'][@index='3']")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(10000);
		dr.findElement(By.xpath("//*[@content-desc='equal'][@index='2']")).click();
		Thread.sleep(10000);
		String act=dr.findElement(By.xpath("//*[@class='android.widget.EditText'][@index='0']")).getAttribute("text");
